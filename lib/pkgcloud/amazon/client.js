...
const Client = exports.Client = function (options) {
  ...
  this.config.signedUrl = Object.assign({ enabled: false, expiresIn: 600 }, options.signedUrl);
  ...
  if (typeof options.signatureVersion === 'string') {
    this._awsConfig.signatureVersion = options.signatureVersion;
  }
