...
exports.getContainer = function (container, callback) {
  const containerName = container instanceof storage.Container ? container.name : container;
  const self = this;
...
exports.createContainer = function (options, callback) {
  const containerName = options instanceof storage.Container ? options.name : options;
  const self = this;
